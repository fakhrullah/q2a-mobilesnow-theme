<?php
	class qa_html_theme extends qa_html_theme_base
	{
		...
		function head_custom() {
			$this->output('<meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; minimum-scale=1.0; user-scalable=no;" />');
		...
		function body_script()
		{
			...
			// theme script
			// $this->output('<script type="text/javascript" src="snap.js" ></script>')
...
element: document.getElementById("snap-content")
    ...
    minPosition: -0});</script>');
		...
		function body()
		{
			...
			// snapJS drawer
			$this->output('<div class="snap-drawers"><div class="snap-drawer snap-drawer-left">');
			qa_html_theme_base::nav('main');
			$this->output('</div></div>');

			// snapJS content
			$this->output('<div id="snap-content" class="snap-content" style="">');
			$this->body_header();
			qa_html_theme_base::nav('sub');
			$this->body_content();
			$this->body_footer();
			$this->body_hidden();
			$this->output('</div>');
